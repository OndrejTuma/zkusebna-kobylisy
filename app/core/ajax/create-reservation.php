	...
	<tr>
		<td>
			...
			<table class=\"list\" cellspacing=\"0\" cellpadding=\"0\" style=\"margin: 50px auto; color: #333; font-family: Arial, Helvetica, sans-serif; font-size: 17px; background: #efefef; padding: 30px; box-shadow: inset 0 0 5px 5px #fff;\">
				...
				<tr>
					<td colspan='2' style='padding: 10px;'>Platbu poukazujte na účet číslo <strong>".Zkusebna::getFormattedAccountNumber()."</strong> (preferujeme), <strong>do zprávy pro příjemce napište název akce ({$reservation_name})</strong>.<br>Nebo hotově správci zkušebny.</td >
				</tr>
				<tr>
